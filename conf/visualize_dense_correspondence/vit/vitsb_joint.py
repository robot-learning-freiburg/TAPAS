...
from conf.encoder.vit_extractor.default import (
    vit_feature_encoder_config as vit_s_config,
)
from conf.encoder.vit_extractor.vitb import vit_feature_encoder_config as vit_b_config
