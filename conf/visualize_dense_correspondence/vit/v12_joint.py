...
from conf.encoder.vit_extractor.default import (
    vit_feature_encoder_config as enc_v1_config,
)
from conf.encoder.vit_extractor.v2 import vit_feature_encoder_config as enc_v2_config
from conf.encoder.vit_extractor.v2_reg import (
    vit_feature_encoder_config as enc_v2_reg_config,
)
...
viz_config = HeatmapVisualizationConfig(
    distance=(v1_config, v2_config, v2_config),
...
encoder_config_v2_reg = EncoderConfig(
    encoder_name="vit_extractor",
    encoder_config=enc_v2_reg_config,
    encoder_suffix=None,
    encoder_naming=encoder_naming_config,
    encoder_path=None,
    vit_extr=True,
...
config = Config(
    encoder=(encoder_config, encoder_config_v2, encoder_config_v2_reg),
    viz=viz_config,
