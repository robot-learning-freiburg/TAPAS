...
vit_config.encoder_config.encoder.use_spatial_expectation = True
...
policy_config = GMMPolicyConfig(
    ...
    pos_lag_thresh=0.002,
    quat_lag_thresh=None,  # 0.4,
    pos_change_thresh=0.0005,
    quat_change_thresh=None,  # 0.04,
    binary_gripper_closed_threshold=0,
    encoder=vit_config,
    encoder_path="data/Sweep/demos_vit_keypoints_encoder-exp.pt",
